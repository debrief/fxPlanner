...
import { Polygon, ParallelTrackParams, Waypoint } from '../../types/behaviors';
import { useMapContext } from '../../contexts/MapContext';
import { generateParallelTrack } from '../../services/PatternService';
import './BehaviorPanel.css';

interface ParallelTrackSearchPanelProps {
  onConfirm: (polygon: Polygon, params: ParallelTrackParams, waypoints: Waypoint[], estimatedDuration: number) => void;
  onCancel: () => void;
}

/**
 * Panel for configuring Parallel Track Search behavior.
 * Allows user to draw search area and configure track parameters.
 * Embedded in tabbed panel (no modal wrapper).
 */
const ParallelTrackSearchPanel: React.FC<ParallelTrackSearchPanelProps> = ({
  onConfirm,
  onCancel,
}) => {
  ...
  return (
    <div className="behavior-panel">
      <div className="panel-header">
        <h3>Configure Parallel Track Search</h3>
      </div>
...
export default ParallelTrackSearchPanel;
