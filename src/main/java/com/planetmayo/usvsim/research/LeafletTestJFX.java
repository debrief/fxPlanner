...
public class LeafletTestJFX extends Application {
    ...
    public void start(Stage stage) {
        ...
        map.setOnActionListener((source, event) -> {
            ...
            if (event instanceof MoveEvent moveEvent) {
                System.out.println("move event: " + moveEvent.action() + " c: " + moveEvent.center() +
                ...
                System.out.println("zoom event: " + zoomEvent.zoomLevel());
    ...
    private void loadDemoElement(JLMapView map) {
        ...
        calgaryMarker.addContextMenu()
                ...
                .setOnMenuItemListener(item -> {
                    System.out.println("Context menu item selected: " + item.getText());
                    switch (item.getId()) {
        ...
        System.out.println("geojson loaded! id: " + geoJsonObject.getJLId());
    }

    private OnJLActionListener<JLMarker> getListener() {
        return (jlMarker, event) -> System.out.println("object " + event.action() + " event for marker:" + jlMarker);
    }
    ...
    private void addPolygon(JLMapView map) {
        ...
        map.getVectorLayer().addPolygon(vertices).setOnActionListener((source, event) ->
                System.out.println(event.action() + " event for: " + source));
    }
